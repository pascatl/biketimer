...
export default function Event(props) {
  ...
  //   });
  //   // console.log(currentEvent);
  // }, [date, startTime, members, leader, eventType, comment]);
        ...
        <MDBCard alignment="center">
          <MDBCardHeader>
            ...
            <MDBRow className="flex-mobile-wrap">
              ...
              <MDBCol center>{createLeader()}</MDBCol>
            </MDBRow>
          </MDBCardHeader>
          <MDBCardBody
              ...
              {/* <MDBCol className={classNames(!editMode && "d-none")} center>
                <MDBDropdown className="mb-3">
                  <MDBDropdownToggle
                    ...
                    className={classNames("bg-success", !editMode && "d-none")}
                    disabled={!editMode}
                    hidden={!editMode}
                  >
                    Person hinzufügen
                  </MDBDropdownToggle>
                  <MDBDropdownMenu>{createDropdownAdd()}</MDBDropdownMenu>
                </MDBDropdown>
              </MDBCol> */}
            </MDBRow>
            <MDBRow>
